    ...
    try {
        ...
        const userWorkouts = await databases.listDocuments(
            ...
            [
                ...
                Query.orderDesc("$createdAt"), // Optional: Order by most recent
                Query.expand("template"), // Expand the 'template' relationship
                Query.expand("userExercise"),
            ]
        );

        console.log("User Workout", userWorkouts);
